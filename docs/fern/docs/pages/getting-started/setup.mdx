...
To get started with Stack Auth, you need a JavaScript project. If you're starting a new project, we recommend a [Next.js project](https://nextjs.org/docs/getting-started/installation) with the app router (the pages router is not supported).
